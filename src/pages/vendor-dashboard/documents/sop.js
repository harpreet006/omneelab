          ...
          <div className="col-12 px-1">
            <div className="row">
              <div className="col-12 pb-1 px-0">
                <h5 className="text-dark backButton pl-0">SOP</h5>
              </div>


              {data && data.documentList.data && data.documentList.data.length > 0 ?
                data.documentList.data.map((val, index) =>
                  <VendorCertificateList docType="sop_certificate" userType="vendor" val={val} srn={index} key={index} docFile="/assets/documents/Space Certificate - Customer.docx" />
                )
                : null}
