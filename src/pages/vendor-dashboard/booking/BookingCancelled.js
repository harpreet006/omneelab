...
const BookingCancelled = () => {
  ...
  useEffect(() => {
    dispatch(vendorBookingAuth(parseInt(pageCount), "CANCELLED"))
  }, [dispatch, pageCount]);
  ...
  const handlePageChange = (pageNumber) => {
    ...
    dispatch(vendorBookingAuth(pageNumber, "CANCELLED"))
  };
        ...
        <div className="row justify-content-end align-items-center px-4 mx-0">
          ...
          <div className="col-12 bg-white custom-shadow p-1 mb-1  tabs-scroll">
            <ul className="nav nav-pills admin-tabs-blue" id="pills-tab" role="tablist">
              ...
              <li className="nav-item">
                <Link to="/vendor/booking-cancel?page=1" className="nav-link vendorActive text-uppercase">Cancelled</Link>
              </li>
            </ul>
          </div>
                          ...
                          <table className="table listTable">
                            <thead>
                              <tr>
                                ...
                                <th className="text-center bg-dark text-white px-2"></th>
                              </tr>
                            </thead>
                            <tbody>
                               ...
                               { data.bookingList.data.map((item, index) => {
                                  return (<BookingList item={item} status="CANCELLED" index={index + 1} key={index} />)
                                })}
