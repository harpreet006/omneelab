          ...
          <div className="col-12"> 
              ...
              <div className="content col-12 download-report"> 
                  <div className="pb-2 border-bottom mb-4 d-sm-flex justify-content-between">
                    <div>
                      <button className="btn name-breadcrumb px-0 text-dark font-heading mr-3 mb-3 toggle-class"><i onClick={()=>history.goBack()} className="fas fa-chevron-left pr-3"></i> GST No.: 12121</button>
                    </div> 
                  </div>
                  <div className="row p-3">
                    <div className="col-xl-8 col-lg-9 col-md-10 col-12">
                      <div className="bg-lighter-primary py-5 px-4">
                        <div className="px-2">
                          <h3 className="text-center mb-5">GST Documents</h3>
