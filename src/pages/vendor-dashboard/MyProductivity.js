        ...
        <div className="row justify-content-end align-items-center py-3 px-3 mx-0">
          <div className="col-12 bg-white custom-shadow p-1 mb-1  tabs-scroll">
            <ul className="nav nav-pills admin-tabs-blue" id="pills-tab" role="tablist">
              ...
              <li className="nav-item">
                <Link to="/vendor/myProductivity" className="nav-link text-uppercase vendorActive">My Productivity</Link>
              </li>
              {/* <li className="nav-item">
            ...
            <div className="tab-content" id="pills-tabContent">
              <div className="tab-pane fade show active" id="pills-warehouse-summary" role="tabpanel" aria-labelledby="pills-warehouse-summary-tab">
                ...
                <div className="row">
                  ...
                  <InfoCard redirect={""} key={0} count={5} title={"Picking Efficiency"} imgIcon={`fas fa-question  text-blue`} />


                  <InfoCard redirect={""} key={0} count={10} title={"Scanning In"} imgIcon={`fas fa-question  text-blue`} />
                  <InfoCard redirect={""} key={0} count={15} title={"Scanning out"} imgIcon={`fas fa-question  text-blue`} />

                
                  <InfoCard redirect={""} key={0} count={20} title={"Order Fulfilment"} imgIcon={`fas fa-question  text-blue`} />

                  <InfoCard redirect={""} key={0} count={20} title={"OTIF"} imgIcon={`fas fa-question  text-blue`} />
