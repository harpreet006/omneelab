        ...
        <Layout>
            ...
            <CustomerLayout title="My Account">
                <div className="border-bottom d-sm-flex justify-content-between">
                    <button className="btn name-breadcrumb px-0 text-dark font-heading mr-3 mb-2"> <i onClick={() => history.goBack()} className="fas fa-chevron-left mr-3"></i> Account</button>
                </div>
                            ...
                            <Form>
                                <div className="row">
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        ...
                                        <input value={data.userProfile?.firstName} type="text"
                                    ...
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        ...
                                        <input
                                            ...
                                            name="city" type="text" className={'form-control form-control-md'} disabled />
                                    ...
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        ...
                                        <input
                                            ...
                                            name="area" type="text" className={'form-control form-control-md'} disabled />
                                    ...
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        ...
                                        <Field
                                            ...
                                            name="address" type="text" className={'form-control form-control-md' + (errors.address && touched.address ? ' is-invalid' : '')} />
                                        <ErrorMessage name="address" component="div" className="invalid-feedback" />
                                    </div>
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        <label htmlFor="staticEmail" className="mb-2">PAN No</label>
                                        <Field
                                            onKeyPress={(e) => onlyAlphaNumericAllow(e)}
                                            name="pan" type="text" className={'form-control form-control-md' + (errors.pan && touched.pan ? ' is-invalid' : '')} />
                                    ...
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        <label htmlFor="staticEmail" className="mb-2">Aadhaar No</label>
                                        <Field
                                            onKeyPress={(e) => onlyAlphaNumericAllow(e)}
                                            name="aadhaar" type="text" className={'form-control form-control-md' + (errors.aadhaar && touched.aadhaar ? ' is-invalid' : '')} />
                                    ...
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        <label htmlFor="staticEmail" className="mb-2">Personal Mail id</label>
                                        <input value={data.userProfile?.email} name="personalEmail" type="text" className={'form-control form-control-md'} disabled />
                                    ...
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        <label htmlFor="staticEmail" className="mb-2">Official Mail id</label>
                                        <Field name="officialEmail" type="text" className={'form-control form-control-md' + (errors.officialEmail && touched.officialEmail ? ' is-invalid' : '')} />
                                    ...
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        <label htmlFor="staticEmail" className="mb-2">Personal Contact no</label>
                                        <input
                                            onKeyPress={(e) => onlyAlphaNumericAllow(e)}
                                            value={data.userProfile?.phone}
                                            name="personalContact" type="text" className={'form-control form-control-md'} disabled />
                                    ...
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        <label htmlFor="staticEmail" className="mb-2">Official Contact no</label>
                                        <Field
                                            onKeyPress={(e) => onlyAlphaNumericAllow(e)}
                                            name="officialContact" type="text" className={'form-control form-control-md' + (errors.officialContact && touched.officialContact ? ' is-invalid' : '')} />
                                        <ErrorMessage name="officialContact" component="div" className="invalid-feedback" />
                                        {/* <input type="text" className="form-control form-control-md" id="staticEmail" value="New Password"/> */}
                                    </div>
                                    <div className="form-group col-lg-4 col-md-6 mb-2">
                                        <label htmlFor="staticEmail" className="mb-2">Blood group</label>
                                        <Field name="bloodGroup" type="text" className={'form-control form-control-md' + (errors.bloodGroup && touched.bloodGroup ? ' is-invalid' : '')} />
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-auto">
                                        <button onClick={() => history.goBack()} type="button" className="btn btn-deep-primary my-4 py-1">Back</button>
                                    </div>

                                    <div className="col-auto">
                                        <button type="submit"
                                            disabled={data.isPending}
                                            className="btn btn-deep-primary my-4 py-1">
                                            Submit
