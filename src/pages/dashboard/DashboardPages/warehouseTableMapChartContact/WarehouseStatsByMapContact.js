                    ...
                    <div className="content col-12">
                        <div className="dashboard-btns pb-1 border-bottom mb-2">
                            ...
                            >
                                ...
                                <li className="nav-item">
                                    <Link to="/customer-stats-by-table-contact" className="nav-link btn-md btn py-2">
                                        Stats By List
                                    </Link>
                                </li>

                                <li className="nav-item">
                                    <Link to="/customer-stats-by-chart-contact" className="nav-link btn-md btn py-2">
                                        Stats By Chart
                                    </Link>
                                </li>

                                <li className="nav-item">
                                    <Link to="/customer-stats-by-map-contact" className="nav-link btn-md btn py-2 active">
                                        Stats By Map
                                    </Link>
                                </li>
