                ...
                <div className="col pt-3">
                  <div className="row">
                    <div className="col-12 mx-auto pb-4">
                      <img
                        className="img-fluid "
                        src="assets/images/SimilarGlossary.png"
                        alt=""
                      />
                    </div>
                    <div className=" col-md-3 col-sm-6 mb-3 ">
                      <div className="card p-2 shadow-sm bg-transparent">
                        <Link to="glossary-detail">  <div className="card-title h5 text-uppercase mb-1 text-white">
                          ERTMS
                        </div>
                    ...
                    <div className=" col-md-3 col-sm-6 mb-3">
                      <div className="card p-2 shadow-sm bg-transparent">
                        <div className="card-title h5 text-uppercase mb-1 text-white">
                          WMS
                        </div>
                        <p className="text-white ">
                          ERTMS is theabbreviation for European Rail Traffic
...
export default SimilarGlossary;
