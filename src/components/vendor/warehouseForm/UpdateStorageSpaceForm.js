...
import { updateStorageSpace, changeWarehouseStatus ,retryGetData ,fetchWarehouseByIdAndType } from '../../../store/actions/vendor/warehouseList';
...
const UpdateStorageSpaceForm = ({ warehouseId, viewMood ,accordionAutoClick }) => {
