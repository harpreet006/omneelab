...
import { updateSafetySecurity, changeWarehouseStatus,retryGetData,fetchWarehouseByIdAndType } from '../../../store/actions/vendor/warehouseList';
...
const SafetySecurityForm = ({ warehouseId, viewMood ,accordionAutoClick }) => {
